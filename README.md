...
If you are unsure what to do or if you do not want to write your blog as Markdown, you can simply write your blog as Word file and after the internal review provide the Work document and all images in jpg or png format to Frank Dürr.
A student assistant will take care to convert the blog entry to Markdown. 

If you want to write your blog entry as Markdown file, follow these steps:
...
* Add your text to the markdown file and copy images to the folder `assets/images/`. Have a look at an existing blog entry in `_posts` to see how to format text and reference images.
